...
<div class="limiter">
    ...
    <div class="row float-l">
        <a href="${pageContext.request.contextPath}/employee" class="btn btn-primary m-t-10 m-r-5">Профиль</a>
    </div>
                ...
                <div class="table100-head">
                    <table>
                        ...
                        <tr class="row100 head">
                            ...
                            <th class="cell100 column5">№ пациента</th>
                        </tr>
                        </thead>
                    </table>
                </div>
                    ...
                    <table>
                        ...
                        <c:forEach var="ticket" items="${tickets}">
                            <tr class="row100 body">
                                ...
                                <td class="cell100 column5">${ticket.patient.username}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
